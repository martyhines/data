...
class ThumbnailsControllerTest < ActionController::TestCase
  ...
  test "should create thumbnail" do
    assert_difference('Thumbnail.count') do
      post :create, thumbnail: { description: @thumbnail.description, image: @thumbnail.image, title: @thumbnail.title }
    end
  ...
  test "should update thumbnail" do
    put :update, id: @thumbnail, thumbnail: { description: @thumbnail.description, image: @thumbnail.image, title: @thumbnail.title }
    assert_redirected_to thumbnail_path(assigns(:thumbnail))
  end
